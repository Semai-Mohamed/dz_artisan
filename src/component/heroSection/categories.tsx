  ...
  return (
    ...
    <div className='w-2/5  flex justify-end  h-4/5 '>
        <div className=' flex flex-col gap-y-6 h-full justify-center    w-4/5' >
            ...
            <div className={` py-2 px-4 text-white font-semibold border-white border-2 rounded-xl flex justify-around gap-x-1 items-center w-36  cursor-pointer  ${data ?'hover:text-greenSofic' : 'hover:text-blueSofic'} hover:bg-white transition-all duration-300 delay-75 ease-in-out `} onMouseEnter={()=>Onmouse(true)} onMouseLeave={()=>Onmouse(false)}><div >Join us</div> <div><FontAwesomeIcon icon={faArrowRight} className={`${mouse ? 'scale-x-150 transform':''}`} beatFade={mouse} size="lg"></FontAwesomeIcon></div></div>
        </div>
    </div>
    <div className='h-full flex flex-col w-3/5  gap-y-6  justify-center'>
        <div className='flex  justify-between items-center  gap-x-5 w-10/12'>
            <div onMouseEnter={()=>Changephoto(true) } onMouseLeave={()=>Changephoto(false)} className={` relative flex gap-y-3 rounded-3xl h-44 flex-1 justify-center items-center bg-categoriesB flex-col text-white text-xs font-semibold hover:shadow-shadowCategorie hover:bg-categoriesWhite  transition-all duration-300 delay-75 ease-in-out  hover:-translate-y-2  ${photo ? (data ? 'hover:text-greenSofic' : 'hover:text-blueSofic') : 'text-white'}`}><div className=' relative w-full h-3/4'><Image className={`w-widthCategorie transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-300 delay-75  ${photo ? ' opacity-100' : 'opacity-0'} `} src={img1 } alt="" /><Image className={`w-5/12 transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-400 delay-75  ${photo ? ' opacity-0' : 'opacity-100'} `} src={img6} alt="" /></div><div className='h-1/3'>Designe & creativity</div></div>
            <div onMouseEnter={()=>Changephoto1(true) } onMouseLeave={()=>Changephoto1(false)} className={` relative flex gap-y-3 rounded-3xl h-44 flex-1 justify-center items-center bg-categoriesB flex-col text-white text-xs font-semibold hover:shadow-shadowCategorie hover:bg-categoriesWhite transition-all duration-300 delay-75 ease-in-out  hover:-translate-y-2 ${photo1 ? (data ? 'hover:text-greenSofic' : 'hover:text-blueSofic') : 'text-white'}`}><div className=' relative w-full h-3/4'><Image className={`w-widthCategorie transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-300 delay-75 ${photo1 ? ' opacity-100' : 'opacity-0'} `} src={img3 } alt="" /><Image className={`w-5/12 transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-400 delay-75 ${photo1 ? ' opacity-0' : 'opacity-100'} `} src={img7} alt="" /></div><div className='h-1/3'>Multimedia</div></div>
            <div onMouseEnter={()=>Changephoto2(true) } onMouseLeave={()=>Changephoto2(false)} className={` relative flex gap-y-3 rounded-3xl h-44 flex-1 justify-center items-center bg-categoriesB flex-col text-white text-xs font-semibold hover:shadow-shadowCategorie hover:bg-categoriesWhite transition-all duration-300 delay-75 ease-in-out  hover:-translate-y-2 ${photo2 ? (data ? 'hover:text-greenSofic' : 'hover:text-blueSofic') : 'text-white'}`}><div className=' relative w-full h-3/4'><Image className={`w-widthCategorie transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-300 delay-75 ${photo2 ? ' opacity-100' : 'opacity-0'} `} src={img2 } alt="" /><Image className={`w-5/12 transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-400 delay-75 ${photo2 ? ' opacity-0' : 'opacity-100'} `} src={img8} alt="" /></div><div className='h-1/3'>Digital Marketing</div></div>
        </div>
        <div className='flex  justify-between items-center  gap-x-5 w-10/12'>
            <div onMouseEnter={()=>Changephoto3(true) } onMouseLeave={()=>Changephoto3(false)} className={` relative flex gap-y-3 rounded-3xl h-44 flex-1 justify-center items-center bg-categoriesB flex-col text-white text-xs font-semibold hover:shadow-shadowCategorie hover:bg-categoriesWhite transition-all duration-300 delay-75 ease-in-out  hover:-translate-y-2 ${photo3 ? (data ? 'hover:text-greenSofic' : 'hover:text-blueSofic') : 'text-white'}`}><div className=' relative w-full h-3/4'><Image className={`w-widthCategorie transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-300 delay-75 ${photo3 ? ' opacity-100' : 'opacity-0'} `} src={img4 } alt="" /><Image className={`w-5/12 transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-400 delay-75 ${photo3 ? ' opacity-0' : 'opacity-100'} `} src={img9} alt="" /></div><div className='h-1/3'>Translation</div></div>
            <div onMouseEnter={()=>Changephoto4(true) } onMouseLeave={()=>Changephoto4(false)} className={` relative flex gap-y-3 rounded-3xl h-44 flex-1 justify-center items-center bg-categoriesB flex-col text-white text-xs font-semibold hover:shadow-shadowCategorie hover:bg-categoriesWhite transition-all duration-300 delay-75 ease-in-out  hover:-translate-y-2 ${photo4 ? (data ? 'hover:text-greenSofic' : 'hover:text-blueSofic') : 'text-white'}`}><div className=' relative w-full h-3/4'><Image className={`w-widthCategorie transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-300 delay-75 ${photo4 ? ' opacity-100' : 'opacity-0'} `} src={img5 } alt="" /><Image className={`w-5/12 transition-all top-2/3 left-1/2 -translate-x-1/2  -translate-y-1/2 absolute duration-400 delay-75 ${photo4 ? ' opacity-0' : 'opacity-100'} `} src={img10} alt="" /></div><div className='h-1/3'>Development</div></div>
